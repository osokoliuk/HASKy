...
-- at runtime using the environment variable HASKy_bindir.
...
-- environment variable HASKy_libdir.
...
-- using the environment variable HASKy_dynlibdir.
...
-- runtime using the environment variable HASKy_datadir.
...
-- using the environment variable HASKy_sysconfdir.
...
libdir     = "/home/oleksii/.cabal/lib/x86_64-linux-ghc-9.10.3-415c/HASKy-0.1.0.0-inplace-HASKy"
dynlibdir  = "/home/oleksii/.cabal/lib/x86_64-linux-ghc-9.10.3-415c"
datadir    = "/home/oleksii/.cabal/share/x86_64-linux-ghc-9.10.3-415c/HASKy-0.1.0.0"
libexecdir = "/home/oleksii/.cabal/libexec/x86_64-linux-ghc-9.10.3-415c/HASKy-0.1.0.0"
